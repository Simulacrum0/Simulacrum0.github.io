...
function TzKa__ChyZo( Zo_wi )
{
	...
	if ( TzKa__Fe_wu < 0 )
	{
		TzKa__Fe_wu = TzKa__Fo_wu - 1;
	}
	else if ( TzKa__Fe_wu >= TzKa__Fo_wu )
	{
		TzKa__Fe_wu = 0;
	}
...
function NzKa__ChyZo( Zo_wi )
{
	...
	if ( NzKa__Fe_wu < 0 )
	{
		NzKa__Fe_wu = NzKa__Fo_wu - 1;
	}
	else if ( NzKa__Fe_wu >= NzKa__Fo_wu )
	{
		NzKa__Fe_wu = 0;
	}
...
function JzKa__ChyZo( Zo_wi )
{
	...
	if ( JzKa__Fe_wu < 0 )
	{
		JzKa__Fe_wu = JzKa__Fo_wu - 1;
	}
	else if ( JzKa__Fe_wu >= JzKa__Fo_wu )
	{
		JzKa__Fe_wu = 0;
	}
		...
		Jz_v.CONTENT.forEach(
			function ( Ti_v, Vx_wu )
			{
				...
				if ( Ti_v.hasOwnProperty( 'DRAW' ) )
				{
					...
					Cha_v.setAttribute(
						"transform", "translate(-" + bb.width / 2 + ",-" + bb.height / 2 + ") \
...
//-------------------------------------------------
{
	...
	if ( x.className === "Dx__NBAR" )
	{
		x.className += " responsive";
	}
	else
	{
		x.className = "Dx__NBAR";
	}
}
